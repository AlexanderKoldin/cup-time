		...
		<footer className='footer'>
			<div className='container footer__container'>
				<a href='!#' className='footer__logo-link'>
					<img src='./image/logo.svg' alt='Cup Time логотип' className='footer__logo' />
				</a>
				<div className='footer__nav'>
					<ul className='footer__menu'>
						<li className='footer__menu-item'>
							<a className='footer__menu-link'>Чай</a>
						</li>
						<li className='footer__menu-item'>
							<a className='footer__menu-link'>Кофе</a>
						</li>
						<li className='footer__menu-item'>
							<a className='footer__menu-link'>Чайник</a>
						</li>
						<li className='footer__menu-item'>
							<a className='footer__menu-link'>Турки</a>
						</li>
						<li className='footer__menu-item'>
							<a className='footer__menu-link'>Прочее</a>
						</li>
					</ul>
				</div>
				...
				<div className='footer__info'>
					...
					<ul className='footer__developers'>
						...
						<li className='footer__developer'>
							Developer:
							<a href='https://github.com/AlexanderKoldin' className='footer__developer-link'>
								{' '}
								Alexander Koldin
							</a>
						</li>
